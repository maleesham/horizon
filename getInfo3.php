...
<?php
 ...
 $query = "INSERT into `transport` (firstName,lastName,email,contactNumber,faculty)
			VALUES ('$fname','$lname','$email','$num','$faculty')";
 $result = mysqli_query($con, $query);

 if ($result) {
 
 echo "<h3><center>You are registered successfully for the transportation of Horizon Campus. </br> Congradulations!!!</center></h3><br/>
 </div>";
 } 
